...
class Dia_My_Recent_Posts_Widget extends WPH_Widget {
	/**
	...
	function __construct() {
		...
		$args = array(
			'label' => __( 'My Recent Posts Example', DIA_TEXTDOMAIN ),
			'description' => __( 'My Recent Posts Widget Description', DIA_TEXTDOMAIN ),
		);
		...
		$args[ 'fields' ] = array(
			...
			array(
				// Field name/label									
				'name' => __( 'Title', DIA_TEXTDOMAIN ),
				// Field description					
				'desc' => __( 'Enter the widget title.', DIA_TEXTDOMAIN ),
				// Field id		
				'id' => 'title',
				...
				'class' => 'widefat',
				// Default value						
				'std' => __( 'Recent Posts', DIA_TEXTDOMAIN ),
				/**
			...
			array(
				// Field name/label									
				'name' => __( 'Taxonomy', DIA_TEXTDOMAIN ),
				// Field description					
				'desc' => __( 'Set the taxonomy.', DIA_TEXTDOMAIN ),
				// Field id		
				'id' => 'taxonomy',
				'type' => 'taxonomy',
				// Class, rows, cols								
			...
			array(
				// Field name/label									
				'name' => __( 'Taxonomy terms', DIA_TEXTDOMAIN ),
				// Field description					
				'desc' => __( 'Set the taxonomy terms.', DIA_TEXTDOMAIN ),
				// Field id		
				'id' => 'taxonomyterm',
				'type' => 'taxonomyterm',
				'taxonomy' => 'category',
			...
			array(
				// Field name/label									
				'name' => __( 'Pages', DIA_TEXTDOMAIN ),
				// Field description					
				'desc' => __( 'Set the page.', DIA_TEXTDOMAIN ),
				// Field id		
				'id' => 'pages',
				'type' => 'pages',
				// Class, rows, cols								
			...
			array(
				// Field name/label									
				'name' => __( 'Post type', DIA_TEXTDOMAIN ),
				// Field description					
				'desc' => __( 'Set the post type.', DIA_TEXTDOMAIN ),
				// Field id		
				'id' => 'posttype',
				'type' => 'posttype',
				'posttype' => 'post',
			...
			array(
				'name' => __( 'Amount' ),
				'desc' => __( 'Select how many posts to show.', DIA_TEXTDOMAIN ),
				'id' => 'amount',
				'type' => 'select',
				// Selectbox fields			
				'fields' => array(
					array(
						// Option name
						'name' => __( '1 Post', DIA_TEXTDOMAIN ),
						// Option value			
						'value' => '1'
					),
					array(
						'name' => __( '2 Posts', DIA_TEXTDOMAIN ),
						'value' => '2'
					),
					array(
						'name' => __( '3 Posts', DIA_TEXTDOMAIN ),
						'value' => '3'
					)
				// Add more options
				),
			...
			array(
				'name' => __( 'Output as list', DIA_TEXTDOMAIN ),
				'desc' => __( 'Wraps posts with the <li> tag.', DIA_TEXTDOMAIN ),
				'id' => 'list',
				'type' => 'checkbox',
				// Checked by default: 
				'std' => 1, // 0 or 1
...
// Register widget
if ( !function_exists( 'dia_my_register_widget' ) ) {
	/**
	 * Initialize the widget
	 * 
	 * @return void
	 */
	function dia_my_register_widget() {
		register_widget( 'Dia_My_Recent_Posts_Widget' );
	}
	add_action( 'widgets_init', 'dia_my_register_widget', 1 );
}
